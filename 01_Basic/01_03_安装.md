...
## 3.1 配置 Composer 缓存位置

默认情况下，Composer 会将下载的依赖包缓存到 C:\Users\<你的用户名>\AppData\Local\Compose, 或者 c:\Users\yzh\AppData\Roaming\Composer\， 如果你想将缓存位置改为其他目录，可以按照以下步骤操作：
1. 设置环境变量
